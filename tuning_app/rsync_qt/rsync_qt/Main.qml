    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            TextField {
                ...
                // Use serverIp provided by C++ if available, otherwise keep default
                text: (typeof serverIp !== 'undefined' && serverIp.length > 0) ? serverIp : "192.168.1.1"
                color: textColor
                background: Rectangle {
                    anchors.fill: parent
                    radius: 10
            ...
            TextField {
                ...
                // Pre-fill password if provided via --password
                text: (typeof serverPassword !== 'undefined') ? serverPassword : ""
                color: textColor
                background: Rectangle {
                    anchors.fill: parent
                    radius: 10
